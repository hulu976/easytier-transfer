...
android {
    compileSdk = 34
    // namespace 与 Kotlin/JNI/Manifest 保持官方包名，JNI 符号不用动；
    // applicationId 改成共存包名，可与官方版（com.easyshare.easytier）并排安装。
    namespace = "com.easyshare.easytier"
    defaultConfig {
        manifestPlaceholders["usesCleartextTraffic"] = "false"
        applicationId = "com.easyshare.easytier"
        minSdk = 24
        targetSdk = 34
